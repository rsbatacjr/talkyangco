	        		...
	        		<div class="container">
	        			<div class="row">
                            <div class="col-md-offset-3 col-md-3">
        						<button style="border-radius: 10px;border: 1px solid #000; padding: 15px; background-color: transparent;width: 200px;" onclick="javascript:window.location='http://128.199.136.69:81/yangco-esl/'">Yangco ESL</button>
						    </div>
						    <div class="col-md-3">
						        <button style="border-radius: 10px;border: 1px solid #000; padding: 15px; background-color: transparent;width: 200px;" onclick="javascript:window.location='http://128.199.136.69:81/ene-center-esl-program/'">EnE ESL</button>
						    </div>
                        </div>
                        <br>
	        		</div>		
